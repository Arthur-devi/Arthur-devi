...
### Desenvolvedor Fullstack • Analista de Infraestrutura • Tecnologia & Automação
...
- 🇧🇷 Localizado no Paraná, Brasil.
- Desenvolvedor Fullstack e Analista de Infraestrutura.
- Interesse em desenvolvimento, infraestrutura, automação e integração de sistemas.
- Sempre buscando melhorar processos através de tecnologia e software.
- Explorando novas tecnologias, arquitetura de sistemas e automações.
